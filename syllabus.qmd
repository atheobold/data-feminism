...
Your grade will decrease by a third of a step (for example a B to a B-) for each B condition that you do not meet. Missing assignments will be scaled, so that if for example you miss four reading annotations your grade will decrease by **one third of a step** (a B to a B-). If you miss four reading annotations **and** you turn the first draft of your data context protocol late your grade will decrease by **two thirds of a step** (a B to a C+).
